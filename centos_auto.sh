...
yum install -y kernel-devel SDL-devel  gcc g++ gdb valgrind git telnet ftp subversion  ibus-pinyin-open-phrase.x86_64 ibus-pinyin.x86_64 libmemcached-devel libevent-devel mysql-devel
